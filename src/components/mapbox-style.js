    ...
    return {
        ...
        "sources": {
            ...
            "os": {
                "type": "vector",
                "scheme": "tms",
                "tiles": ["http://localhost:8081/geoserver/gwc/service/tms/1.0.0/TestVectorTiles%3Abhbm3856@3857@pbf/{z}/{x}/{-y}.pbf"]
            }
        },
        "center": [ 117.3,31.74],
        "zoom": 14,
        "sprite": '/proxy/sprites',
        ...
        },
        {
            ...
            "filter": ["all", ["==", "structure", "tunnel"], ["==", "class", "motorway_link"]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "filter": ["all", ["==", "structure", "tunnel"], ["in", "class", "service", "track"]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "filter": ["all", ["==", "structure", "tunnel"], ["==", "class", "link"]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "filter": ["all", ["==", "structure", "tunnel"], ["in", "class", "street", "street_limited"]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "filter": ["all", ["==", "structure", "tunnel"], ["in", "class", "secondary", "tertiary"]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "filter": ["all", ["==", "structure", "tunnel"], ["in", "class", "trunk", "primary"]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "filter": ["all", ["==", "structure", "tunnel"], ["==", "class", "motorway"]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "filter": ["all", ["==", "class", "motorway_link"], ["!in", "structure", "bridge", "tunnel"]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "filter": ["all", ["in", "class", "service", "track"], ["!in", "structure", "bridge", "tunnel"]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "filter": ["all", ["==", "class", "link"], ["!in", "structure", "bridge", "tunnel"]],
            "type": "line",
            "source": "mapbox",
            "id": "road_link_casing",
            "paint": {
        ...
        },
        {
            ...
            "filter": ["all", ["==", "$type", "LineString"], ["all", ["in", "class", "street", "street_limited"], ["!in", "structure", "bridge", "tunnel"]]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "filter": ["all", ["in", "class", "secondary", "tertiary"], ["!in", "structure", "bridge", "tunnel"]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "filter": ["all", ["in", "class", "trunk", "primary"], ["!in", "structure", "bridge", "tunnel"]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "filter": ["all", ["==", "class", "motorway"], ["!in", "structure", "bridge", "tunnel"]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "source": "mapbox",
            "source-layer": "road",
            "filter": ["all", ["==", "$type", "LineString"], ["all", ["in", "class", "path", "pedestrian"], ["!in", "structure", "bridge", "tunnel"]]],
            "paint": {
                "line-color": "#cba",
                "line-dasharray": [1.5, 0.75],
                "line-width": {
        ...
        },
        {
            ...
            "source": "mapbox",
            "source-layer": "road",
            "filter": ["all", ["==", "class", "major_rail"], ["!in", "structure", "bridge", "tunnel"]],
            "paint": {
                "line-color": "#bbb",
                "line-width": {
                    "base": 1.4,
        ...
        },
        {
            ...
            "filter": ["all", ["==", "structure", "bridge"], ["==", "class", "motorway_link"]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "filter": ["all", ["==", "structure", "bridge"], ["in", "class", "service", "track"]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "filter": ["all", ["==", "structure", "bridge"], ["==", "class", "link"]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "filter": ["all", ["==", "structure", "bridge"], ["in", "class", "street", "street_limited"]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "filter": ["all", ["==", "structure", "bridge"], ["in", "class", "secondary", "tertiary"]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "filter": ["all", ["==", "structure", "bridge"], ["in", "class", "trunk", "primary"]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "filter": ["all", ["==", "structure", "bridge"], ["==", "class", "motorway"]],
            "type": "line",
            "source": "mapbox",
        ...
        },
        {
            ...
            "source": "mapbox",
            "source-layer": "road",
            "filter": ["all", ["==", "$type", "LineString"], ["all", ["==", "structure", "bridge"], ["in", "class", "path", "pedestrian"]]],
            "paint": {
                "line-color": "#cba",
                "line-dasharray": [1.5, 0.75],
                "line-width": {
        ...
        },
        {
            ...
            "source": "mapbox",
            "source-layer": "road",
            "filter": ["all", ["==", "structure", "bridge"], ["==", "class", "major_rail"]],
            "paint": {
                "line-color": "#bbb",
                "line-width": {
                    "base": 1.4,
        ...
        },
        {
            ...
            "filter": ["all", ["==", "$type", "Point"], ["in", "scalerank", 1, 2, 3]],
            "type": "symbol",
            "source": "mapbox",
            "id": "airport_label",
            "paint": {
        ...
        },
        {
            ...
            "filter": ["in", "type", "hamlet", "suburb", "neighbourhood", "island", "islet"],
            "type": "symbol",
            "source": "mapbox",
